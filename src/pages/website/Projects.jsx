        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Project <span className="text-[#870481]">Success</span>
            </h2>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-lg font-semibold text-white">Filter Projects</span>
            </div>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-[#870481] font-semibold text-sm">{project.client}</span>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Project <span className="text-[#870481]">Process</span>
            </h2>
